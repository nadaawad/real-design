...
FILE * A_matrix , *Multiples_Matrix, *col_nos_matrix ,*Parameters_matrix , *B_matrix;
...
int additional_b =((MatrixSize*1)%(8) !=0)? (8-((MatrixSize*1)%(8))):0;
...
fprintf(Parameters_matrix,"%08X",total_with_additional_A);
